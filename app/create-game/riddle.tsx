...
const CreateRiddlePage = () => {
	...
	const handleSubmit = async () => {
		...
		try {
			...
			Alert.alert("Success", "Your Riddle game has been created successfully!", [
				{
					text: "OK",
					onPress: () => router.back(),
				},
	...
	return (
		<View style={styles.container}>
			...
			<View style={[styles.header, { paddingTop: insets.top + Spacing.sm }]}>
				...
				<Text style={styles.headerTitle}>Create Riddle</Text>
			...
			>
				...
				>
					...
					Create a multiple choice riddle. Mark the correct answer with the checkbox.
					</Text>
...
export default CreateRiddlePage;
